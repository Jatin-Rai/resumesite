    ...
    return (
        ...
        >
            <div className="flex flex-col sm:w-1/2 justify-center gap-8">
                <h1 className="flex flex-col pt-5 gap-4 text-4xl font-semibold">
                    Hi,{" "}
                    <span>
                        I'm
                ...
                <div className="text-red-600 dark:text-cyan-300 text-4xl font-bold">
                    <h3>
                        <ReactTyped
                ...
                <div className="flex gap-4">
                    <a href="https://www.linkedin.com/in/jatinrai96/" target='_blank' rel="noreferrer">
                        <FaLinkedin className="text-blue-800 text-3xl hover:animate-bounce" />
                    </a>
                    ...
                    <a href="https://www.instagram.com/jatin.j.rai/" target='_blank' rel="noreferrer">
                        <FaInstagram className="text-pink-600 text-3xl hover:animate-bounce" />
                    </a>
                </div>
            </div>
